...
CREATE DATABASE IF NOT EXISTS empresa_webiii_projeto2_modificado;# 1 linha afectada.

USE empresa_webiii_projeto2_modificado;# MySQL não retornou nenhum registo.
